...
import './OperatorsMiddleSect.scss'


const OperatorsMiddleSect = () =>{
    ...
    return(
        <div className="operators-middle">
            ...
            <div className="top-section-light-table">
                <div className="light-name"><div>100009 Белогольская Алина Сергеевна</div></div>
                <div className="light-duration">
                    <div className="duration-green">
                        <div>00:48</div>
                    </div>
                </div>
                <div className='received-numb'><div>2</div></div>
                <div className='missed-numb'><div>2</div></div>
                <div className='outdoing-numb'><div>0</div></div>
                <div className='numb'>
                    <div className="act">
                        <div>Актуализация</div>
                    </div>
                </div>
            </div>

            <div className="top-section-dark-table">
                <div className="dark-name"><div>100012 Усова Ирина Викторовна</div></div>
            ...
            <div className="top-section-light-table">
                <div className="light-name"><div>100020 Еремеева Диана Андреевна</div></div>
                <div className="light-duration">
                ...
                <div className='outdoing-numb'><div>2</div></div>
                <div className='numb'>
                    <div className="numb-outbox">
                        <div className="outbox-icon"/>
                        <div>Исходящий обзвон</div>
                    </div>
                </div>
            </div>
            ...
            <div className="top-section-dark-table">
                ...
                <div className='outdoing-numb'><div>2</div></div>
                <div className='numb'>
                    <div className="numb-worcking">
                        <div className="worcking-icon"/>
                        <div>Исходящий обзвон</div>
                    </div>
                </div>
            </div>
            ...
            <div className="top-section-light-table">
                <div className="light-name"><div>100008 Хозяенко Наталья Викторовна</div></div>
                <div className="light-duration">
                    <div className="duration-green">
                        <div>13:34</div>
                    </div>
...
export default OperatorsMiddleSect;